...
import com.banana.cinemer.activities.RecipeActivity;
import com.banana.cinemer.activities.RecipeActivity;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MovieViewHolder holder, int position) {
        ...
        final Recipe movie = Database.RECIPES[position];
        ...
        holder.rateTextView.setText(String.valueOf(movie.rating));
    ...
    public int getItemCount() {
        // вернуть количество
        return Database.RECIPES.length;
    }

    /**
     * Метод стартует активность с подробной информацией по фильму movie.
     */
    private void startMovieActivity(Recipe movie) {
